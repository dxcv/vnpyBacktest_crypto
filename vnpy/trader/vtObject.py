...
class VtBarData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.datetime = None                # python的datetime时间对象
        self.tradedate = EMPTY_STRING       # bar归属交易日期,这里在导入数据库的时候处理
        self.time = EMPTY_STRING            # 时间
        self.datetime_start = None          # python的datetime时间对象,这根Bar的起始时间
        self.datetime_end = None            # python的datetime时间对象，这根Bar的终止时间，注意：同周期bar datetime不重合
...
class VtTradeData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.tradeTime = EMPTY_STRING           # 成交时间，datetime对象
        self.datetime = None                    # 成交的日期
        self.tradedate = EMPTY_STRING           # 成交归属日期
