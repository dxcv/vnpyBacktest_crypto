...
from vnpy.trader.app.ctaStrategy.ctaBacktesting_cryptocontract import BacktestingEngine, MINUTE_DB_NAME
...
if __name__ == '__main__':
    ...
    # 设置回测用的数据起始日期,起始日期十天
    engine.setStartDate('2017-01-03', 10)

    # 设置产品相关参数
    engine.setSlippage(0)           # 测试品种1跳
    # engine.setRate(0.3 / 10000)   # 万0.3
    engine.setRate(0)       # 千分之二
    engine.setPriceTick(0.1)          # 测试最小价格变动
    engine.setSize(100)             # 设置交易多少张合约，交易100张合约起
    engine.setCapital(0.05)          # 本金两个BTC
